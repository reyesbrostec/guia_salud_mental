...
const ACCESS_PANEL_HTML = `<!-- accessibility-panel: dynamic via assets/js/accessibility.js -->`;
{
  ...
  // Inject a visible accessibility toggle button if missing
...
<style>
  html.acc-visual { font-size: 1.15rem; }
    html.acc-visual body > *:not(#accessibility-btn):not(#accessibility-panel):not(script):not(style) { filter: contrast(1.05) saturate(1.05); }
